...
class SimpleChatBot:
    ...
    def find_best_answer(self, input_sentence):
        r = sorted(self.questions, key = lambda n: self.calc_distance(input_sentence, n)) # questions 리스트의 각 요소에 대해 calc_distance(input_sentence, n) 함수를 호출하여 레벤슈타인 거리를 계산하고, 이를 기준으로 리스트를 정렬
